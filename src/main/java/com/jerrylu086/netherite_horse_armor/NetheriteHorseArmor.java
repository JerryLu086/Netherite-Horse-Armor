...
public class NetheriteHorseArmor {
    ...
    public static class Configuration {
        ...
        static {
            ...
            WEIGHT = BUILDER.comment("How much weight you want your horse armor to be in the loot table? Set to 0 to disable. (default: 8, about 20% chance)").defineInRange("weight", 8, 0, Integer.MAX_VALUE);
